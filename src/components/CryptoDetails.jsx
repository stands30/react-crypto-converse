...
function CryptoDetails() {
    ...
    const { data: coinHistory, isHistoryFetching } = useGetCryptoHistoryQuery({ coinId, timePeriod});
    ...
    return (
        <Col className="coin-detail-container">
            <Col className="coin-heding-container">
            ...
            <Col className="stats-container">
                ...
                <Col className="other-value-statistics">
                    <Col className="coin-value-statistics-heading">
                        ...
                        <p>An overview showing the statistics of {cryptoDetails.name}, such as the base and quote currency, the rank, and trading volume.</p>
                    {genericStats.map(( { icon, title, value}, statIndex ) =>(
                        <Col className="coin-stats" key={statIndex}>
                            <Col className="coin-stats-name">
                                    <Text>{icon}</Text>
                                    <Text>{title}</Text>
                            </Col>
